...
// ficheiro resultante pode até ficar maior do que o original.
export function isLossless(file) {
  return file.type === 'image/png';
}

// A imagem sai no mesmo formato em que entrou. Um PNG devolve um PNG.
