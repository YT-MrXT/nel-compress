// O catbox não envia cabeçalhos CORS, por isso o browser não pode falar com
...
const UPSTREAM = 'https://catbox.moe/user/api.php';
...
export default async (request) => {
  ...
  return new Response(upstream.ok ? body : `[proxy] o catbox respondeu ${upstream.status}`, {
    status: upstream.status,
    headers: { 'content-type': 'text/plain' },
  });
};

export const config = { path: '/api/catbox' };
