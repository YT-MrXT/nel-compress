...
async function intake(file) {
  ...
  el('setupNote').textContent =
    mode === 'image' && isLossless(file)
      ? 'O PNG não tem perdas: o valor de qualidade não se aplica e o ficheiro pode ficar maior. Para o encolher a sério, converte para JPG ou WebP.'
      : currentMode().note;
}
