...
// acontece do lado do servidor, pela regra no ficheiro _redirects.
  ...
  return new Promise((resolve, reject) => {
    ...
    request.onload = () => {
      ...
      if (request.status === 200 && body.startsWith('https://')) {
        ...
        reject(new Error('O endereço /api/litterbox não existe. Falta o ficheiro _redirects na raiz do site.'));
      } else {
