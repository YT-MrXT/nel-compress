  ...
  return new Promise((resolve, reject) => {
    ...
    request.onload = () => {
      ...
      if (request.status === 200 && body.startsWith('https://')) {
        ...
        reject(new Error(
          `O endereço /api/litterbox devolveu ${request.status} sem passar pelo proxy. A Edge Function não está publicada: confirma que a pasta netlify/ e o netlify.toml estão na raiz do repositório.`
        ));
      }
    };
